...
const _1_expect = 10;
const _1_actual = add(5,5);
console.assert(_1_actual === _1_expect, 'Test 1');

const _2_expect = -0.0;
const _2_actual = add(0,0);
...
const _4_expect = -0.4;
const _4_actual = add(-0.2,-0.2);
console.assert(_4_actual === _4_expect, 'Test 4');

const _5_expect = 0.30000000000000004;
const _5_actual = add(0.1,0.2);
console.assert(_5_actual === _5_expect, 'Test 5');

const _6_expect = 30454;
const _6_actual = add(15226,15228);
console.assert(_6_actual === _6_expect, 'Test 6');

const _7_expect = -1;
const _7_actual = add(-1,0);
console.assert(_7_actual === _7_expect, 'Test 7');

const _8_expect = 0;
const _8_actual = add(-400,400);
console.assert(_8_actual === _8_expect, 'Test 8');

const _9_expect = Infinity;
const _9_actual = add(Infinity,Infinity);
...
const _1_actual = strictEqual(1,false);
console.assert(_1_actual === _1_expect, 'Test 1');

const _2_expect = true;
const _2_actual = strictEqual(true, true);
console.assert(_2_actual === _2_expect, 'Test 2');

const _3_expect = true;
const _3_actual = strictEqual(0,0);
console.assert(_3_actual === _3_expect, 'Test 3');

const _4_expect = false;
const _4_actual = strictEqual(1,0);
console.assert(_4_actual === _4_expect, 'Test 4');

const _5_expect = true;
const _5_actual = strictEqual('string','string');
console.assert(_5_actual === _5_expect, 'Test 5');

const _6_expect = false;
const _6_actual = strictEqual('string','');
console.assert(_6_actual === _6_expect, 'Test 6');

const _7_expect = true;
const _7_actual = strictEqual(undefined,undefined);
console.assert(_7_actual === _7_expect, 'Test 7');

const _8_expect = false;
const _8_actual = strictEqual(true,false);
console.assert(_8_actual === _8_expect, 'Test 8');

const _9_expect = false;
const _9_actual = strictEqual(NaN,NaN);
console.assert(_9_actual === _9_expect, 'Test 9');
...
const sameTruthiness = (a, b) => {
  ...
  const result = Boolean(a) === Boolean(b) ? true :false;
...
const mystery = (a) => {
  ...
  const result = isNaN(a)? true :false;
